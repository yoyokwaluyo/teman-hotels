        ...
        <div class="flex max-sm:flex-col items-center justify-center gap-10 max-sm:gap-3 mt-16">
            ...
            <div class="relative">
                <div class="flex items-center gap-2">
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-black bg-white hover:opacity-90 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center" type="button">
                        <div id="btn_sbs">1 - 5</div>
                ...
                <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-24 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton" id="sbs_value">
                        <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            <div class="font-medium text-sm">1 - 5</div>
                        </li>
                        <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            <div class="font-medium text-sm">6 - 10</div>
                        </li>
                        <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            <div class="font-medium text-sm">11 - 15</div>
                        </li>
                        <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            <div class="font-medium text-sm">16 - 20</div>
                        </li>
                        <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            <div class="font-medium text-sm">21 - 25</div>
                        </li>
                        <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            <div class="font-medium text-sm">26 - 30</div>
                        </li>
                        <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            <div class="font-medium text-sm">36 - 40</div>
                        </li>
                        <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            <div class="font-medium text-sm">46 - 50</div>
                        </li>
                        <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            <div class="font-medium text-sm">56 - 60</div>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="w-1/2 h-full mx-auto grid grid-cols-2 max-sm:grid-cols-1 items-center place-items-center gap-4 mt-14">
            ...
            <div class="w-[300px] h-full p-5 rounded-lg shadow-lg bg-gray-100">
                <div class="text-center">
                    ...
                    <h5 class="text-sm font-light mt-2">Monthly based on transaction</h5>
                    <div class="min-h-[100px] mt-3 flex items-center justify-center">
